...
// ==================== 导出全局函数 ====================
// 将关键函数暴露为全局函数，供其他模块调用
window.getStreamsList = getStreamsList;
window.addStream = addStream;
window.deleteStream = deleteStream;
window.fetchDashboard = fetchDashboard;
window.fetchDashboardByStream = fetchDashboardByStream;
window.startLive = startLive;
window.stopLive = stopLive;
window.updateVotes = updateVotes;
window.resetVotes = resetVotes;
window.fetchAIContentList = fetchAIContentList;
window.deleteAIContent = deleteAIContent;
window.deleteAIContentComment = deleteAIContentComment;
window.getDebateFlowConfig = getDebateFlowConfig;
window.saveDebateFlowConfigAPI = saveDebateFlowConfigAPI;
window.fetchJudgesByStream = fetchJudgesByStream;
